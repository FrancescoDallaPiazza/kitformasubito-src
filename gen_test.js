...
async function genTestGenerale() {
  ...
  function buildChildren(isDocente) {
    return [
      makeTopTable(),
      vuoto(20),
      new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:40},children:[new TextRun({text:'TEST DI FORMAZIONE GENERALE',bold:true,font:FONT,size:28,color:C.BLU_DARK})]}),
